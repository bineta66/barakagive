<template>
  <form @submit.prevent="submit" class="space-y-4">
    ...
    <div class="flex gap-3 pt-2">
      <button
        type="button"
        class="flex-1 border border-sky-900 text-sky-900 px-4 py-2 rounded-lg font-semibold text-sm"
      >
        Annuler
      </button>
      ...
      <button
        type="submit"
        class="flex-1 bg-slate-900 hover:bg-slate-800 text-white px-4 py-2 rounded-lg font-semibold text-sm"
      >
        Enregistrer
      </button>
    </div>
