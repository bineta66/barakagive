        ...
        >
          ...
          <td class="px-4">
            <div class="flex justify-end gap-2">
              <RouterLink :to="`/projets/${projet.code}`" class="text-slate-500 hover:text-sky-700">
                <Eye :size="18" />
              </RouterLink>

              <RouterLink :to="`/projets/modifier/${projet.code}`" class="text-slate-500 hover:text-amber-700">
                <Pencil :size="18" />
              </RouterLink>
