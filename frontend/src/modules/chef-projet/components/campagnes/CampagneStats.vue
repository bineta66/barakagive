<template>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div class="bg-white border border-slate-200/60 shadow rounded-xl p-4 flex justify-between">
      <div>
        <p class="text-xs font-bold uppercase text-slate-900">Planifi̩es</p>
        <h3 class="text-xl font-bold text-slate-800 mt-2">{{ statistiques.planifiees }}</h3>
      </div>
...
<script setup>
import { ClipboardList, Activity, Calendar, CheckCircle } from "lucide-vue-next"
