        ...
        <div>
          ...
          <span
            ...
            :class="{
              ...
              'bg-sky-100 text-sky-700': projet.statut === 'Terminée',
              'bg-gray-100 text-gray-600': projet.statut === 'Planifiée',
            }"
          >
            {{ projet.statut }}
          </span>
          ...
          <tr v-for="justificatif in projet.justificatifs" :key="justificatif.id" class="border-t">
            ...
            <td class="px-4 py-2">
              <div class="flex justify-end">
                <button class="text-slate-500 hover:text-sky-900" title="Télécharger">
                  <Download :size="18" />
                </button>
              </div>
            </td>
